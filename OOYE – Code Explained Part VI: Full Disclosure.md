# OOYE – Code Explained Part VI: Full Disclosure

Oh Hey! Look at you, you’ve made it to Part VI. I’m going to guess you’ve mastered parts 1-5 so you’re ready to continue to this final part and see the code I wrote for Out Of Your Element, or you already know how to program in Python and want to see my code, or maybe you’re just curious about what my code looks like to the game I made.

No matter which one of those things you’re here for, you’re here to see the goods.. you want the :cough: Full Disclosure :cough:.

You can check out the code below or view it on [github](https://github.com/thisislink/OutOfYourElement):
...
If you’ve followed along, I want to say thanks, and hopefully you learned something and if you ever struggled with programming or fear of making your own game. I also hope you have the confidence to push through that, now that you see how easy it can be.
